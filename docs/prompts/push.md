...
Contesto tema:
- cartella: laravel/Themes/Three;
- branch atteso: dev;
- remote reali da git remote -v:
  - laraxot -> git@github.com:laraxot/theme_three_fila5.git (remote raggiungibile);
  - provtv -> git@github.com:provtv/theme_three_fila5.git.

Procedura operativa:
1. Vai in laravel/Themes/Three.
...
- commit sync locale pubblicato: b716b55;
- provtv/dev verificato: HEAD...provtv/dev = 0 0;
- laraxot/dev verificato: HEAD...laraxot/dev = 0 0;
- push laraxot riuscito: c70b273..b716b55;
